...
const Map: { [index: number]: [string, [number,string, string, number][]] } = {
  1: ["0x2796317b0fF8538F253012862c06787Adfb8cEb6",[
    ...
    [0,"nUSD", String(Tokens.NUSD.address(1)), Number(Tokens.NUSD.decimals(1))],
  ]],     // ethereum
  ...
  10: ["0xAf41a65F786339e7911F4acDAD6BD49426F2Dc6b",[
    ...
    [0,"nUSD", String(Tokens.NUSD.address(10)), Number(Tokens.NUSD.decimals(10))],
  ]],     // optimism
  ...
  137: ["0x8F5BBB2BB8c2Ee94639E55d5F41de9b4839C1280",[
    ...
    [0,"nUSD", String(Tokens.NUSD.address(137)), Number(Tokens.NUSD.decimals(137))],
  ]],     // polygon
  ...
  42161: ["0x6F4e8eBa4D337f874Ab57478AcC2Cb5BACdc19c9",[
    ...
    [0,"nUSD", String(Tokens.NUSD.address(42161)), Number(Tokens.NUSD.decimals(42161))],
  ]],     // arbitrum
  ...
  43114: ["0xC05e61d0E7a63D27546389B7aD62FdFf5A91aACE",[
    ...
    [0,"nUSD", String(Tokens.NUSD.address(43114)), Number(Tokens.NUSD.decimals(43114))],
  ]],     // avalanche
  ...
  250:["0xAf41a65F786339e7911F4acDAD6BD49426F2Dc6b",[
    ...
    [0,"nUSD", String(Tokens.NUSD.address(250)), Number(Tokens.NUSD.decimals(250))],
  ]] //fantom
}
const EthPrice = 1200
